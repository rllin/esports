...
class FST:
    def __init__(self, filename):
        #self.target_keys = [49, 81, 87, 69, 82, 68]
        self.target_keys = [65, 83, 68, 70]
    ...
    def IKI(self, section):
        ...
        ikis = []
        times_since = []
        current = [0,] * len(self.target_keys)
        iki = [0,] * len(self.target_keys)
        time_since = [0,] * len(self.target_keys)
